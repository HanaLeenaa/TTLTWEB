...
INSERT INTO products VALUES (NULL, 1, 11, 'Neo Geo Mini International', 'là phiên bản nâng cấp với độ trễ cực thấp và độ bền vượt trội. Cảm biến Hall Effect chống drift, Khoá Trigger đa chế độ, Kết nối 3 chế độ, Tương thích PC / Android / iOS', 'Neo Geo Mini International là console mini hoài cổ. Thiết kế dạng tủ arcade nhỏ gọn. Màn hình tích hợp. Cài sẵn nhiều game kinh điển. Dễ chơi và sưu tầm.', 'CPU ARM Cortex, GPU Mali, Game Neo Geo tích hợp', 2490000, 2990000, 'https://images-na.ssl-images-amazon.com/images/I/71LnMXwSSmL.jpg', NOW(), 250, 3, 540, 1, 'neo-geo-mini-international', 0, 'Tay cầm Neo Geo, Cáp HDMI, Cáp nguồn', 'HDMI, USB');
