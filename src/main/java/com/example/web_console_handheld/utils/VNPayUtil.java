...
public class VNPayUtil {
    ...
    /**
     * Hàm tạo URL thanh toán VNPay hỗ trợ nhận tên miền động từ Servlet gửi sang
     */
    public static String createPaymentUrl(long amount, String txnRef, String ipAddr, String returnUrl) {
        try {
            ...
            // 🌟 SỬ DỤNG RETURN URL ĐỘNG ĐƯỢC TRUYỀN VÀO TỪ SERVLET
            ...
            // Đơn hàng tự hết hạn sau 15 phút nếu không thanh toán
            calendar.add(Calendar.MINUTE, 15);
            String expireDate = formatter.format(calendar.getTime());
            params.put("vnp_ExpireDate", expireDate);

            // Tiến hành ký mã băm bảo mật chữ ký điện tử
